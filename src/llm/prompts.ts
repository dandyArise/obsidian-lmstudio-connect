...
You MUST call the read_file tool, passing the exact string inside the brackets as the path argument.
...
<tool_calling>
You have exactly one tool at your disposal: read_file.
